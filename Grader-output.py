...
for test_case_file in test_case_files:
    ...
    output_result_file=f"{assignment_folder}/{problem_name}/test_cases/output_result_{os.path.basename(test_case_file)}"
    with open(output_result_file,"w") as f:
        f.write(program_output.rstrip())
    output_test_case_file=f"{assignment_folder}/{problem_name}/test_cases/output_{os.path.basename(test_case_file)}"
    with open(output_test_case_file,"w") as f:
        f.write("".join(parser.test_case_outputs).rstrip())
